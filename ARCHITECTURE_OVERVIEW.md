...
- nomes explícitos por feature;
- centralização da navegação;
- repositório principal offline-first;
- validações de formulário separadas quando necessário.

### Atenções futuras
- reduzir warnings de arquivos ainda marcados como “unused” pela IDE;
- revisar periodicamente migrations e schemas Room;
- manter README e `FILE_RESPONSIBILITIES.md` atualizados quando novas features forem adicionadas.
